...
public class User {
    ...
    public User(Long id, @NotNull String username, @NotNull int status, @NotNull String userKey) {
        this.id = id;
    ...
    public User(@NotNull String username, @NotNull int status, @NotNull String userKey, Cart cart) {
        this.username = username;
        this.status = status;
        this.userKey = userKey;
        this.cart = cart;
